...
export const metadata: Metadata = {
  title: 'Events',
  description: 'Discover upcoming D Global Entertainment nights, afrobeats, amapiano, house and more.',
};
      ...
      <div className="container-px py-14 md:py-20 relative">
        <div className="max-w-3xl">
          ...
          <p className="mt-4 text-muted md:text-lg max-w-xl">
            Curated, produced and hosted by D Global Entertainment. Grab tickets early, the best sets sell out first.
          </p>
        </div>
