...
// token is present. Without a token (local builds, fork PRs) it's a no-op
// wrapper — the runtime SDK still works, you just lose source-mapped
// stack traces in the Sentry dashboard.
export default withSentryConfig(nextConfig, {
  silent: !process.env.SENTRY_AUTH_TOKEN,
  org: process.env.SENTRY_ORG,
  project: process.env.SENTRY_PROJECT,
  authToken: process.env.SENTRY_AUTH_TOKEN,
  // Tunnel client-side events through our own origin so ad-blockers and
  // strict CSPs don't drop them. The route is generated by the SDK.
  tunnelRoute: '/monitoring',
  hideSourceMaps: true,
  disableLogger: true,
  // Skip Sentry uploads when the secrets aren't set (e.g. PR previews).
